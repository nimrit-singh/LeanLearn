...
const Feedback: React.FC<FeedbackProps> = ({ onSubmit, onSkip }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      <div className="w-full max-w-[512px] bg-[#1A1A1A] rounded-lg p-8">
        ...
        <div className="mb-6">
          <textarea
            ...
            className="w-full h-[120px] bg-[#101113] text-white rounded-lg p-4 resize-none focus:outline-none focus:ring-2 focus:ring-[#00A3FF]"
          />
        </div>
