...
const QuestionBank: React.FC = () => {
  ...
  const [classQuestionCounts, setClassQuestionCounts] = useState<{
    [key: string]: number;
  }>({});
  ...
  return (
    <>
      <div className="md:hidden flex items-center absolute p-4 pl-8 mb-2 z-20">
        {!isSidebarOpen && (
          <button
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-white text-sm">
                      {classQuestionCounts[classData.id.toString()] || 0}{" "}
                      questions
                    </span>
                    <svg
                      width="20"
