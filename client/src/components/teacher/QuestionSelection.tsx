...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  return (
    <div className="w-full bg-[#111111] rounded-lg p-4 relative group">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`w-6 h-6 border rounded-sm ${
                isSelected ? 'bg-[#21B6F8] border-[#21B6F8]' : 'border-gray-500'
          ...
          {'options' in question ? (
            <div className="space-y-2">
              {question.options.map((option, index) => (
                <div key={index} className="p-2 bg-[#1A1A1A] rounded">
                  {option}
                </div>
              ))}
            </div>
            ...
            <div className="flex gap-4">
              <button className="px-4 py-2 bg-[#1A1A1A] rounded">True</button>
              <button className="px-4 py-2 bg-[#1A1A1A] rounded">False</button>
            </div>
          )}
        </div>
      </div>
